...
- July 22, 2025: **CORREGIDO SEMÁFORO DE SALUD FINANCIERA** - Identificada y corregida card de Estado morada que mostraba "Excelente" incorrectamente, cambiada lógica de markup (precio/costo) a evaluación de presupuesto (costo real vs costo estimado), con 5% sobrecosto ahora muestra "Regular" apropiadamente, formato de sobrecosto mejorado a "+5%" en lugar de "105%", sistema de semáforo implementado: Excelente (≤85%), Bueno (≤100%), Regular (≤110%), Crítico (>110%)
