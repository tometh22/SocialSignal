-- 0054 — Ajuste programado de precio por IPC para contratos en ARS.
...
-- A lo sumo un ajuste sin resolver por cotización. El chequeo en
-- server/jobs/ipc-price-adjustments.ts ya evita proponer dos, pero es un
-- SELECT-then-insert sin lock — este índice es la garantía real a nivel de
-- base ante dos corridas del cron superpuestas.
