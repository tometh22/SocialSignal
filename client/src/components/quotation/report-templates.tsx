...
export default function ReportTemplates({ onPrevious, onNext }: { onPrevious: () => void; onNext: () => void }) {
  ...
  const { data: originalTemplates, isLoading } = useQuery<ReportTemplate[]>({
  ...
  const validateForm = () => {
    if (selectedTemplateId === null) {
      toast({
        ...
        description: "Por favor, selecciona una plantilla de informe o elige la opción 'Personalizado / Sin Plantilla'.",
        variant: "destructive",
      });
      return false;
    }
          ...
          <div className="mb-4">
            <Button 
              ...
              className={cn(
                ...
                selectedTemplateId === -1 && "bg-blue-50 border-blue-500 text-blue-700"
              )}
              onClick={() => {
                // Usamos un ID especial como -1 para representar "Sin plantilla"
                updateReportTemplate(-1);
                toast({
                  title: "Sin Plantilla Seleccionada",
                  description: "Continuarás sin usar una plantilla predefinida. Podrás configurar el equipo manualmente.",
                });
              }}
            >
              <div className="text-center">
                <h4 className="text-base font-medium">Personalizado / Sin Plantilla</h4>
      ...
      <div className="bg-white rounded-lg shadow mt-6 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div className="overflow-hidden rounded-lg border border-neutral-200">
              <table className="min-w-full divide-y divide-neutral-200">
                ...
                <tbody className="bg-white divide-y divide-neutral-200">
                  ...
                  {selectedTemplateId && selectedTemplateId > 0 && templates && (
                    <tr>
                      <td className="px-4 py-2 text-sm text-neutral-900">Plantilla</td>
                      <td className="px-4 py-2 text-sm text-neutral-900">
                        {templates.find(t => t.id === selectedTemplateId)?.name || "Personalizado / Sin Plantilla"}
                      </td>
                      <td className="px-4 py-2">
                  ...
                  {selectedTemplateId === -1 && (
                    <tr>
                      <td className="px-4 py-2 text-sm text-neutral-900">Plantilla</td>
                      <td className="px-4 py-2 text-sm text-neutral-900">Personalizado / Sin Plantilla</td>
                      <td className="px-4 py-2">
          ...
          <div className="lg:col-span-1">
            <h4 className="text-base font-medium text-neutral-700 mb-3">Factores de Complejidad</h4>
            <div className="h-64 bg-neutral-50 rounded-lg border border-neutral-200 p-2">
