...
function KPICard({
  ...
  return (
    <div className={`rounded-xl border ${borderColor} px-3 py-2.5 min-w-[100px] flex-1 transition-all hover:shadow-sm`}>
    ...
    <>
      ...
      >
        ...
        <div className="px-4 pt-2 pb-4">
          ...
          {/* ── KPI Cards Grid ── */}
          {canSeeCosts && (
            <div className="mt-4 pt-4 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
              {revenue > 0 && (
                <KPICard
