 ...
 * Versión optimizada con mejor espaciado y sin superposiciones
 */
const ProjectSummaryOptimized = ({
  project,
  costSummary,
  timeEntries,
  personnel,
  ...
  return (
    <TooltipProvider>
      <div className="px-4 lg:px-6 py-6 bg-background">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-card rounded-xl shadow-sm border p-4">
            <div>
              ...
              <Card className="border shadow-sm overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-white pb-2">
                  <div className="flex justify-between items-center">
                    <CardTitle className="text-base font-medium text-blue-800 flex items-center">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-60 text-xs">Las horas registradas indican el tiempo total dedicado al proyecto. Se dividen en facturables (que se cobran al cliente) y no facturables (trabajo interno)</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                </CardHeader>
                ...
                <CardHeader className="bg-gradient-to-r from-green-50 to-white pb-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-60 text-xs">Muestra los gastos acumulados en relación al presupuesto total asignado. Un valor cercano al 100% indica que se está agotando el presupuesto disponible.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                </CardHeader>
                ...
                <CardHeader className="bg-gradient-to-r from-amber-50 to-white pb-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-60 text-xs">Muestra los días que quedan hasta la fecha de finalización estimada. Ayuda a evaluar si se cumplirá con los plazos establecidos.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                </CardHeader>
        ...
        <Tabs defaultValue="overview" className="mb-8">
          <TabsList className="mb-6 w-full md:w-auto border-b rounded-none h-11 bg-transparent p-0 justify-start">
          ...
          <TabsContent value="overview" className="space-y-8 mt-2 p-0">
            {/* Sección de Gráficos principales */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Gráfico de tendencia de tiempo y costo */}
              <Card className="border shadow-sm overflow-hidden col-span-full">
                ...
                <CardContent className="p-4">
                  <div className="h-72 p-3 bg-white rounded">
              ...
              <Card className="border shadow-sm overflow-hidden">
                ...
                <CardContent className="p-4">
                  <div className="h-60 p-3 bg-white rounded">
          ...
          <TabsContent value="riesgos" className="space-y-8 mt-2 p-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <CardHeader className="py-3 bg-slate-50">
                  <div className="flex justify-between items-center">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-60 text-xs">Muestra las desviaciones en costos y tiempo respecto a lo planificado. Una desviación positiva indica que se está excediendo lo planificado.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <CardDescription>
                ...
                <CardHeader className="py-3 bg-slate-50">
                  <div className="flex justify-between items-center">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-60 text-xs">Estos indicadores evalúan la probabilidad de que el proyecto exceda su presupuesto o plazo, basándose en las tendencias actuales de gasto y avance.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <CardDescription>
                    ...
                    <div className="bg-white rounded-lg border p-4">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <div className={`px-2 py-1 rounded text-xs font-semibold ${
                          ...
                          {(riskIndicators?.budgetRisk || 0) > 70 ? "Alto" : 
                           (riskIndicators?.budgetRisk || 0) > 30 ? "Medio" : "Bajo"}
                        </div>
                      </div>
          ...
          {/* Tab de entregables */}
          <TabsContent value="entregables" className="space-y-8 mt-2 p-0">
                ...
                <CardContent className="p-4">
                  {deliverableData ? (
                    <div>
                      ...
                      {/* Agregar más detalles o una tabla de entregables si los hay */}
                    </div>
                  ) : (
                    <div className="bg-white rounded-lg border p-6 text-center">
                      <CircleAlert className="h-8 w-8 mx-auto mb-3 text-muted-foreground opacity-40" />
          ...
          {/* Tab de equipo */}
          <TabsContent value="equipo" className="space-y-8 mt-2 p-0">
            <div className="grid grid-cols-1 gap-6">
              {/* Sección de Equipo */}
              <Card className="border shadow-sm overflow-hidden">
                <CardHeader className="py-3 bg-slate-50">
                  <div className="flex justify-between items-center">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="w-60 text-xs">Muestra el personal asignado al proyecto y cómo se distribuye el tiempo entre los distintos roles.</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <CardDescription>
...
export default ProjectSummaryOptimized;