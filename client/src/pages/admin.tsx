                ...
                <CardContent className="p-0">
                  {rolesLoading ? (
                      ...
                      <Table>
                        <TableHeader className="bg-slate-50">
                          <TableRow className="hover:bg-slate-50 border-none">
                            ...
                            <TableHead className="font-semibold text-slate-700">Tarifa Predeterminada</TableHead>
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-center px-4">
                      ...
                      <h3 className="text-lg font-medium text-slate-700 mb-2">No hay roles definidos</h3>
                      <p className="text-slate-500 mb-6 max-w-md">
                        Los roles definen las posiciones en el equipo del proyecto y sus tarifas predeterminadas.
                        Crea tu primer rol para comenzar a estructurar tu equipo.
                      </p>
                      <Button onClick={openNewRoleDialog} className="gap-2 bg-blue-600 hover:bg-blue-700">
                        <PlusCircle className="h-4 w-4" />
                        Crear Primer Rol
