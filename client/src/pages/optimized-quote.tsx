...
const OptimizedQuoteContent: React.FC = () => {
  ...
  return (
    <div className="flex flex-col bg-gray-50 pb-16">
      {/* Encabezado con gradiente moderno (estilo actual) */}
      ...
      <div className="px-4 pt-3 pb-2 flex-grow max-w-7xl mx-auto w-full">
        {/* Navegación de pasos mejorada (estilo moderno) */}
        <div className="mb-3">
          <Tabs 
            ...
            className="w-full"
          >
            <TabsList className="grid grid-cols-4 w-full h-9 bg-white p-0.5 rounded border border-gray-200 shadow-sm">
              <TabsTrigger 
                value="1" 
                disabled={currentStep < 1}
                className="data-[state=active]:bg-blue-50 data-[state=active]:text-blue-600 rounded transition-all text-xs h-8"
              >
                <div className="flex items-center">
                  <span className="bg-blue-100 text-blue-600 w-4 h-4 rounded-full flex items-center justify-center text-[10px] mr-1.5 font-medium">1</span>
              ...
              >
                <div className="flex items-center">
                  <span className="bg-blue-100 text-blue-600 w-4 h-4 rounded-full flex items-center justify-center text-[10px] mr-1.5 font-medium">2</span>
              ...
              >
                <div className="flex items-center">
                  <span className="bg-blue-100 text-blue-600 w-4 h-4 rounded-full flex items-center justify-center text-[10px] mr-1.5 font-medium">3</span>
              ...
              >
                <div className="flex items-center">
                  <span className="bg-blue-100 text-blue-600 w-4 h-4 rounded-full flex items-center justify-center text-[10px] mr-1.5 font-medium">4</span>
        ...
        {/* Contenedor principal con estilos modernos */}
        <div className="bg-white rounded-md shadow-sm border border-gray-200 p-3 mb-[70px] overflow-visible">
        ...
        {/* Tarjetas de ayuda con estilo moderno y compacto */}
        {currentStep === 1 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-6">
            <div className="bg-blue-50 border border-blue-100 rounded-md shadow-sm overflow-hidden">
              <div className="flex items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10"></circle>
                  <line x1="12" y1="16" x2="12" y2="12"></line>
                  <line x1="12" y1="8" x2="12.01" y2="8"></line>
                </svg>
                <h3 className="text-blue-700 text-xs font-medium">Consejo</h3>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-md shadow-sm overflow-hidden">
              <div className="flex items-center p-2">
                ...
                <h3 className="text-blue-700 text-xs font-medium">Recomendación</h3>
              </div>
              <div className="px-2 pb-2">
                <p className="text-[11px] text-blue-900 leading-tight">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-md shadow-sm overflow-hidden">
              <div className="flex items-center p-2">
                ...
                <h3 className="text-blue-700 text-xs font-medium">Plantillas populares</h3>
              </div>
              <div className="px-2 pb-2">
                <p className="text-[11px] text-blue-900 leading-tight">
      ...
      {/* Botones de navegación (fijos en la parte inferior) - estilo moderno */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-2 px-4 z-50 shadow-sm">
