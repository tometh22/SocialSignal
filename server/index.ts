...
async function applyPendingMigrations() {
  ...
  try {
    ...
    // 0022: columnas históricas 2027 + tipo de cambio en cierre mensual
    await run('0022 2027_costs_and_exchange_rate', `
    ...
    await run('0021 personnel_absences', `
      ...
      CREATE INDEX IF NOT EXISTS "idx_personnel_absences_pid" ON "personnel_absences"("personnel_id");
      CREATE INDEX IF NOT EXISTS "idx_personnel_absences_dates" ON "personnel_absences"("start_date", "end_date");
    `);
