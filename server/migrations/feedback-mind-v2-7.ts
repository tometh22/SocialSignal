/**
 * Runtime copy of migrations/0035_feedback_mind_v2_7_closure.sql.
 * Production applies this idempotent closure during application startup.
 */
export const feedbackMindV27MigrationSql = String.raw`
