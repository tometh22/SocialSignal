// Generado a partir de migrations/0052_quotation_groups.sql — mantener en sync.
export const quotationGroupsMigrationSql = String.raw`
...
ALTER TABLE quotation_deliveries ADD COLUMN IF NOT EXISTS group_delivery_id integer REFERENCES quotation_group_deliveries(id) ON DELETE SET NULL;
