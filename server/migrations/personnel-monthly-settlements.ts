// Generado a partir de migrations/0061_personnel_monthly_settlements.sql — mantener en sync.
export const personnelMonthlySettlementsMigrationSql = String.raw`
